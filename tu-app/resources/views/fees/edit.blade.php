                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="fee_type" id="fee_type"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    required>
                                    <option value="monthly" {{ old('fee_type', $fee->fee_type) == 'monthly' ? 'selected' : '' }}>Bulanan</option>
                                    <option value="yearly" {{ old('fee_type', $fee->fee_type) == 'yearly' ? 'selected' : '' }}>Tahunan</option>
                                    <option value="one_time" {{ old('fee_type', $fee->fee_type) == 'one_time' ? 'selected' : '' }}>Sekali Bayar</option>
                                </select>
                                @error('fee_type')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="academic_year" id="academic_year"
                                    value="{{ old('academic_year', $fee->academic_year) }}" placeholder="2025/2026"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
